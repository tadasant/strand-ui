...
class TestQuerySlackApplicationInstallations:
    ...
    def test_get_slack_team_installation(self, slack_application_installation_factory, client):
    ...
    @pytest.mark.django_db
    def test_get_slack_application_installations(self, slack_application_installation_factory, client):
